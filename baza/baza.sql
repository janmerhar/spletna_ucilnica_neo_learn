...
CREATE TABLE IF NOT EXISTS `learn`.`uporabnik` (
  ...
  `avatar` VARCHAR(255) NULL DEFAULT 'learn.png',
  PRIMARY KEY (`upime`),
...
CREATE TABLE IF NOT EXISTS `learn`.`ucilnica_has_test` (
  `iducilnica_has_test` INT NOT NULL,
  `ucilnica_has_testcol` VARCHAR(45) NULL,
  `ucilnica_has_testcol1` VARCHAR(45) NULL,
  `ucilnica_has_testcol2` VARCHAR(45) NULL,
  `ucilnica_has_testcol3` VARCHAR(45) NULL,
  `ucilnica_has_testcol4` VARCHAR(45) NULL,
  `ucilnica_has_testcol5` VARCHAR(45) NULL,
  `ucilnica_has_testcol6` VARCHAR(45) NULL,
  PRIMARY KEY (`iducilnica_has_test`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `learn`.`resuje` (
  `test_idtest` INT NOT NULL AUTO_INCREMENT,
  `uporabnik_upime` VARCHAR(255) NOT NULL,
